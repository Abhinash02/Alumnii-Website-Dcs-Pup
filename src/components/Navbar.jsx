        ...
        {isMenuOpen && (
          ...
          >
            <ul className="flex flex-col gap-4 text-[#fff] font-medium items-center py-4">
              ...
              <li>
                <Link
                  to="https://docs.google.com/forms/d/e/1FAIpQLSf5mj2-fGe6UcxUhdUt2iRK26F8WD1Gk9Br0PdvJofuQkeA9w/viewform"
                  target="blank"
                >
                  <button className="bg-darkBlue hover:bg-[#222363] text-[#fff] op font-semibold rounded-lg py-2 px-3">
                    Register Now!
                  </button>
                </Link>
              </li>
